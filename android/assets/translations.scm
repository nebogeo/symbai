(define i18n-text
  (list
   ...
   (list 'general-agreement-text (list "General agreement text here..."))
   ...
   (list 'no-education (list "No education"))
   ...
   (list 'change-id (list "Change photo" "" ))
   ...
   (list 'bio-mother (list "Biological mother" "" ))
   (list 'bio-father (list "Biological father" "" ))
   ...
   (list 'social-relationship (list "Relation to you" "" ))
   (list 'social-residence (list "Residence" "" ))
   (list 'social-strength (list "In the last year how often have you talked to them?" "" ))
   ...
   (list 'spouse (list "Spouse" "" ))
   (list 'children (list "Children" "" ))
   (list 'eldest-uncle (list "Eldest uncle"))
   (list 'co-wife (list "Co-wife" "" ))
   (list 'spouse-mother (list "Spouse's mother" "" ))
   (list 'spouse-father (list "Spouse's father" "" ))
   (list 'spouse-brother (list "Spouse's brother" "" ))
   (list 'spouse-sister (list "Spouse's sister" "" ))
   ...
   (list 'religious-leader (list "Religious leader" "" ))
   (list 'village-leader (list "Village leader" "" ))
   (list 'same (list "Same" "" ))
   (list 'daily (list "Every day" "" ))
   (list 'weekly (list "About once a week" "" ))
   (list 'monthly (list "About once a month" "" ))
   (list 'less (list "Less than one a month" "" ))
   ...
   (list 'friendship-question (list "LIST UP TO FIVE PERSONS with whom you really like to talk and whom you have spoken to in the last year. They can be men or women. They can be your friends or relatives. They can be your spouse. They can be people living in this village or in another village. Anyone whom you like to talk to." ))
   (list 'prestige-question (list "LIST UP TO FIVE PERSONS who you think are the most respected, whom you respect from the heart: They can be men or women. They can be your friends or relatives. They can be your spouse. They can be people living in this village or in another village."))
   (list 'knowledge-question (list "LIST UP TO FIVE PERSONS who you think are the most knowledgeable: They can be men or women. They can be your friends or relatives. They can be your spouse. They can be people living in this village or in another village." ))
   ...
   (list 'social-answered (list "Agreed to answer?"))
   (list 'friendship-answered (list "Agreed to answer?"))
   (list 'chooser-no-selection (list "Clear"))
   (list 'hybrid (list "Hybrid"))
   (list 'local (list "Local"))
   (list 'dont-know (list "Dont know"))
   (list 'do-move (list "Move me!"))
   (list 'move-are-you-sure (list "Are you sure you want to move me?"))
   (list 'same-village (list "Same village"))
   (list 'other-village (list "Other village"))
   (list 'mother-residence (list "Mother's current village"))
   (list 'father-residence (list "Father's current village"))
   (list 'spouse-residence (list "Spouse's current village"))
